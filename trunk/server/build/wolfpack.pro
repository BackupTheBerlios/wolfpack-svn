...
LIBS += -lboost_python -L../3rdparty/boost/lib/ -lzlib -L../3rdparty/zlib/lib/
INCLUDEPATH += ../3rdparty/boost/include ../3rdparty/zlib
...
QMAKE_TARGET_COPYRIGHT = Copyright (c) 2000-2013 Wolfpack Development Team
